    ...
    return (
        ...
        <footer className="bg-gray-100">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex flex-col gap-4 md:justify-between">
                    <div className="my-6 md:my-12 mx-auto">
                        <h3 className=" text-2xl font-semibold text-center mb-2 text-blue-700">Blu gadgets</h3>
                        <p className="text-center max-w-lg mx-auto mb-4">Leading the way in cutting-edge technology and innovation.</p>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-center">
                        <div>
                            ...
                            <ul className="text-gray-500  font-medium">
                                <li className="mb-4">
                                    <a href="" className="hover:underline">Product Support</a>
                                </li>
                                <li className="mb-4">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center ">© 2025 <a href="" className="hover:underline">Blu Gadgets</a>. All Rights Reserved.
                    </span>
